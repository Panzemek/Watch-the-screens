...
(
    id int NOT NULL AUTO_INCREMENT, 
    network_image varchar(255) NOT NULL,
    network_full varchar(255) NOT NULL,
    network_short varchar(255) NOT NULL
);
...
(
    ...
    round_created int NOT NULL,
    start_trigger_type varchar(255) NOT NULL,
    start_trigger_value varchar(255) NOT NULL,
    end_trigger_type varchar(255) NOT NULL,
    end_trigger_value varchar(255) NOT NULL,
    is_hidden boolean NOT NULL DEFAULT false,
    FOREIGN KEY (game_id) REFERENCES game(id)
);